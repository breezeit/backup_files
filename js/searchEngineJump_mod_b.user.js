...
",
          insertIntoDoc: {
            keyword: (function() {
              return decodeURI(location.href.match(/s=(.*?$)/)[1])
            }),
            target: 'css;.shadow',
            where: 'afterEnd',
          },
...
',
      ...
      engineList.download[0] = {
        name: '天天美剧',
        url: 'http://www.ttmeiju.com/index.php/search/index.html?keyword=%s&range=0',
        favicon: 'http://www.ttmeiju.com/favicon.ico',
